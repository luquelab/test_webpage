...
| PhD student, [**Abelardo Aguilar**]({{ '/pages/team/#abelardo-aguilar' | relative_url }}) and postdocs, [**Omer Nadel**]({{ '/pages/team/#omer-nadel' | relative_url }}) and [**Michael Cioffi**]({{ '/pages/team/#michael-cioffi' | relative_url }}) represented the Luque lab at the 2025 University of Miami Graduate Student and Postdoctoral Research Symposium hosted in the Shalala Center. Abelardo displayed his work on finding the evolutionary connection between HK97 and encapsulins as a poster, while Omer and Mike delivered oral presentations highlighting their work on reconstructing small novel capsids and creating simulations of T=3 capsids, respectively. | <img src="{{ '/assets/images/news/2025-03-25_research_symposium.jpg' | relative_url }}" width="200" height="200"> |

| [**Spanish Network of Physical Virology (BioFiViNet)**](#spanish-network-of-physical-virology-2025-03-20) | March 20, 2025 |
| PI, [**Antoni Luque**]({{ '/pages/team/#antoni-luque' | relative_url }}) delivered the opening plenary at the VII Spanish Network of Physical Virology [BioFiViNet](https://sites.google.com/view/guzmanresearch/physvirspain), a network he helped establish in 2010 as a PhD student under Prof. Dr. David Reguera at the University of Barcelona, one of its initial organizers. | <img src="{{ '/assets/images/news/2025-03-21_BioFiNet_memoire.jpeg' | relative_url }}" width="400" height="200"> |

| [**Invited talk at Technion - Israel Institute of Technology**](#invited-talk-at-technion-israel-institute-of-technology) | March 16, 2025 |
| Postdoc, [**Omer Nadel**]({{ '/pages/team/#omer-nadel' | relative_url }}) was invited by [Oded Beja's lab](https://beja.net.technion.ac.il/) to present his research within the Luque lab. During the presentation, Omer discussed his findings in expressing miniphages at SDSU facilities and hinted at future avenues of research for the lab. | <img src="{{ '/assets/images/news/2025-03-16_TIIT_OMER.png' | relative_url }}" width="300" height="100"> |

| [**Computational Biology Focus Area Retreat**](#computational-biology-focus-area-retreat) | March 13, 2025 |
| PI, [**Antoni Luque**]({{ '/pages/team/#antoni-luque' | relative_url }}) was invited to present at a panel of computational biologists hosted by the University of Miami Miller School of Medicine. Dr. Luque presented the lab's research utilizing simulation technology for uncultured viral capsids headed by postdoc [**Michael Cioffi**]({{ '/pages/team/#michael-cioffi' | relative_url }}), the connected project investigating viral evolution headed by graduate student [**Abelardo Aguilar**]({{ '/pages/team/#abelardo-aguilar' | relative_url }}), and applying knowledge of viral structure to develop vaccine technology headed by graduate student [**Md Imran Noor**]({{ '/pages/team/#md-imran-noor' | relative_url }}). | <img src="{{ '/assets/images/news/2025-03-13_computational_biology_focus_area_retreat.png' | relative_url }}" width="200" height="100"> |

| [**U-Link Predoctoral Fellowship Proposals**](#u-link-predoctoral-fellowship-proposals) | March 6, 2025 |
| Graduate students [**Abelardo Aguilar**]({{ '/pages/team/#abelardo-aguilar' | relative_url }}) and [**Md Imran Noor**]({{ '/pages/team/#md-imran-noor' | relative_url }}) submitted proposals for the [U-Link predoctoral fellowship](https://ulink.miami.edu/projects/u-link-predoctoral-fellowship/index.html), aiming to utilize multidisciplinary approaches for innovative scientific research. Abelardo focuses on the biochemical functions of viral procapsids with the HK97 fold through comparative genomics, structural predictions, and molecular modeling. Noor is dedicated to engineering larger Adeno-associated virus (AAV) capsids to enhance genetic payload capacity for advanced gene therapy and vaccine delivery platforms. | <img src="{{ '/assets/images/news/2025-03-06_u-link_proposals.png' | relative_url }}" width="300" height="100"> |

| [**Guest Speaker for Career Development Presentation**](#guest-speaker-for-career-development-presentation) | March 5, 2025 |
| Research associate [**Lucas Carbajal**]({{ '/pages/team/#lucas-carbajal' | relative_url }}) was invited to speak in a BIL 299 career development seminar course, where he presented his path from recent graduate to research associate within the Luque lab. | <img src="{{ '/assets/images/news/2025-03-05_bil_299_seminar_group.jpeg' | relative_url }}" width="150" height="100"> |

| [**Student Research Symposium (Envision)**](#student-research-symposium-2024-10-4) | October 4, 2024 |
| Undergraduate student [**Jose-Bernard Sedalo**]({{ '/pages/team/#jose-bernard-sedalo' | relative_url }}) displayed his project on identification of disassembly units in viral capsids and took home third place in the STEM category. | <img src="{{ '/assets/images/news/2024-10-4_student_symposium.jpeg' | relative_url }}" width="100" height="100"> |
...
| Dr. Luque presented the lab’s progress in predicting viral capsids from metagenomic data at Flinders University (Adelaide, Australia). | ![picture]({{ '/assets/images/news/5_fame_aug_17_22.png' | relative_url }}) |
...
| **[Contribution to the SDSU Research Highlights](https://research.sdsu.edu/2020_research_highlights/luque)** | Dec 21, 2020 |
